...
#}
    ...
    {% else %}
        <input 
            type="{% if type_text %}text{% elseif type_email %}email{% elseif type_number %}number{% elseif type_tel %}tel{% elseif type_password %}password{% elseif type_hidden %}hidden{% endif %}"
            {% if input_id %}id="{{ input_id }}"{% endif %}
