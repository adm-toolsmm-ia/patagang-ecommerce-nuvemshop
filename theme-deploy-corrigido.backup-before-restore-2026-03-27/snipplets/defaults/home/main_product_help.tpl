                        ...
                        <div class="row">
                            ...
                            <div class="col-md p-0 px-md-3">
                                <div class="js-swiper-product-demo swiper-container product-detail-slider">
                                    <div class="labels">
                                        <div class="label label-accent free-shipping">
                        ...
                        <div class="pt-md-3">
                            ...
                            <div class="price-container my-2">
                                ...
                                <span class="d-inline-block">
                                    <div class="h3 mb-2 price-compare">{{ price_value | money }}</div>
                                </span>
                                <span class="d-inline-block">
                                    <div class="h4 product-price mb-0 text-brand">{{ price_value | money }}</div>
                                </span>
