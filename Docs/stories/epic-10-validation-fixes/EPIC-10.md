...
| 10.2 | Modal Galeria — Restaurar CSS ausente (close/backdrop/counter) | @dev | @qa | Baixo-Médio | 🔄 In Progress |
| 10.3 | PDP Mobile — Remover espaço duplo no banner informativo | @dev | @qa | Baixo | ⬜ Draft |
