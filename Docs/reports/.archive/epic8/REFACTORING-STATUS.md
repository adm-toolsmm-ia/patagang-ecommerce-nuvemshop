...
| **Guia de Execução** | `Docs/epics/.archive/refactoring-execution-guide.md` | Passo-a-passo por fase |
...
2. Seguir guia: `Docs/epics/.archive/refactoring-execution-guide.md` → Phase 1
