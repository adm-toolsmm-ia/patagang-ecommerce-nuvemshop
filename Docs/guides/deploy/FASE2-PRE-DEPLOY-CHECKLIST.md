...
- `Docs/stories/.archive/8.2/guides/8.2-FASE2-DEPLOY-VALIDATION-GUIDE.md`
...
2. **Validação falhou:** Consulte `Docs/stories/.archive/8.2/guides/8.2-FASE2-DEPLOY-VALIDATION-GUIDE.md` (Troubleshooting)
