...
✅ Guia de execução passo-a-passo
   → docs/guides/pdp-deploy-execution-guide.md
...
- [ ] Bookmark: `docs/guides/pdp-deploy-execution-guide.md`
...
3. `docs/guides/pdp-deploy-execution-guide.md` — Deploy step-by-step
