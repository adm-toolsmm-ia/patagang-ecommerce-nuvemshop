...
DOMContentLoaded.addEventOrExecute(() => {
	...
	{#/*============================================================================
	  #Lazy-load Olark (Story 8.5 — Priority 1 — v1.5.74)
	  Moved from external.js.tpl for performance optimization
	  Chat loads AFTER page renders (DOMContentLoaded)
	==============================================================================*/ #}

	// Lazy-load Olark live chat if configured
	if (typeof window.store !== 'undefined' && window.store && window.store.live_chat) {
		...
		olark.identify(window.store.live_chat);
	}
