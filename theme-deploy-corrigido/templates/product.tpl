...
{# Estrutura: Identity banner + Banner informativo do produto + Galeria/Card separados #}
...
{# SEÇÃO 2: BANNER INFORMATIVO DO PRODUTO (full width, FORA da seção de galeria/card) #}
